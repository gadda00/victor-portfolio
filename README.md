...
- **v11 pricing & pipeline pass**: all service pricing doubled site-wide (Audit $9,000 · Starter $5,000 + $700/mo · Growth $28,000 + $6,000/mo · Enterprise $50K–$200K+ · services $3,000–$24,000 · training $600–$36,000) with every mirrored surface kept in sync; proposal generator completes the 7-stage pipeline; premium dark-brand resume PDF at `/resume/`; `/services/` now injects ProfessionalService + FAQPage JSON-LD generated from `data.json` (schema prices can never drift from published prices).
...
- **Notes for the owner**:
  - The AI Reliability Audit price shown ("From $9,000 · 1–2 weeks") is a placeholder in the same effort class as AI Audit — confirm before relying on it.
