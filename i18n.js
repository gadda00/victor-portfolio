...
(function () {
  ...
  var dict = {
    en: {
      ...
      'nav.contact': 'Contact',
      'nav.book': 'Book an Assessment',
      'nav.dashboard': 'Dashboard',
      'hero.badge': 'Available for select engagements · Nairobi 🇰🇪 & remote',
      'hero.title1': 'AI Engineer',
      'hero.title2': 'Founder',
      'hero.title3': 'Researcher',
      'hero.meta.loc': '📍 Nairobi, Kenya',
      'hero.meta.mission': 'Building for Africa & the world',
      'hero.cta.work': 'See the systems I have shipped',
      'hero.cta.book': 'Book a 30-Minute AI Systems Assessment',
    ...
    sw: {
      ...
      'nav.book': 'Weka Miadi ya Tathmini',
      'nav.dashboard': 'Dashibodi',
      'hero.badge': 'Ninapatikana kwa mashirika machache · Nairobi 🇰🇪 na mbali',
      'hero.title1': 'Injiniya wa AI',
      'hero.title2': 'Mwanzilishi',
      'hero.title3': 'Mtafiti',
      'hero.meta.loc': '📍 Nairobi, Kenya',
      'hero.meta.mission': 'Ninajenga kwa Afrika na dunia',
      'hero.cta.work': 'Tazama Mifumo Niliyojenga',
      'hero.cta.book': 'Weka Miadi ya Tathmini ya Mifumo ya AI',
